...
const Header = () => {
  ...
  return (
    <div className='w-full shadow-md md:justify-between bg-primary-color md:top-0 md:left-0 py-4 px-3 md:flex md:items-center'>
      ...
      <ul
        className={`md:flex md:gap-8 md:pl-0 pl-4 absolute md:static bg-primary-color md:z-auto z-[1] left-0 w-full pb-6 md:w-auto transition-all duration-500 ease-in ${
